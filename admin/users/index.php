      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="kelola-users-tab">
            <div class="form-group">
                <a href="<?php echo $cfg_baseurl; ?>admin/users/add/" class="btn btn-primary btn-bordered waves-effect w-md waves-light"><i class="fa fa-plus"></i> Tambah Data </a>
            </div>
            <div class="form-group">
                <form method="GET">
...
if (isset($_GET['search'])) {
	$search = $_GET['search'];
	$query_list = "SELECT * FROM users WHERE username LIKE '%$search%' ORDER BY username ASC"; // edit
} else {
	$query_list = "SELECT * FROM users ORDER BY user_id ASC"; // edit
}
...
$no = 1;
												...
												?>
														...
														<td align="center">
															<a href="<?php echo $cfg_baseurl; ?>admin/users/edit/?id=<?php echo $data_show['user_id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
															<a href="<?php echo $cfg_baseurl; ?>admin/users/delete/?id=<?php echo $data_show['user_id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
