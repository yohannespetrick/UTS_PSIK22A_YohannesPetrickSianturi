      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="kelola-contact-tab">
            <div class="form-group">
                <a href="<?php echo $cfg_baseurl; ?>admin/contact/add/" class="btn btn-primary btn-bordered waves-effect w-md waves-light"><i class="fa fa-plus"></i> Tambah Data </a>
            </div>
            <div class="form-group">
                <form method="GET">
...
if (isset($_GET['search'])) {
	$search = $_GET['search'];
	$query_list = "SELECT * FROM contact WHERE contact_name LIKE '%$search%' ORDER BY contact_type ASC"; // edit
} else {
	$query_list = "SELECT * FROM contact ORDER BY update_at DESC"; // edit
}
...
$no = 1;
												while ($data_show = mysqli_fetch_assoc($new_query)) {
												    if($data_show['contact_type'] == "wa"){
												        $tampilnya = "Whatsapp";
												    } elseif($data_show['contact_type'] == "ig"){
												        $tampilnya = "Instagram";
												    }
												?>
												        <td><?php echo $no++; ?></td>
														<td><?php echo $tampilnya; ?></td>
														<td><a href="<?php echo $data_show['contact_target']; ?>"><?php echo $data_show['contact_name']; ?></a></td>
														<td><?php echo $data_show['update_at']; ?></td>
														<td align="center">
															<a href="<?php echo $cfg_baseurl; ?>admin/contact/edit/?id=<?php echo $data_show['contact_id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
															<a href="<?php echo $cfg_baseurl; ?>admin/contact/delete/?id=<?php echo $data_show['contact_id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
