    ...
    <div class="card-box">
      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="kelola-about-tab">
            <?php
            $check_about_exist = $db->query("SELECT title FROM about_us");
            if ($check_about_exist->num_rows == 0) {
            ?>
            <div class="form-group">
                <a href="<?php echo $cfg_baseurl; ?>admin/about/add/" class="btn btn-primary btn-bordered waves-effect w-md waves-light"><i class="fa fa-plus"></i> Tambah Data </a>
            </div>
            <?php
            } else {
            ?>
            <div class="alert alert-warning">
              <i class="fa fa-warning"></i>
                  Maksimal 1 baris data untuk about!
            </div>
            <?php
            }
            ?>
...
if (isset($_GET['search'])) {
	$search = $_GET['search'];
	$query_list = "SELECT about_id,title,update_at FROM about_us WHERE title LIKE '%$search%' ORDER BY update_at DESC"; // edit
} else {
	$query_list = "SELECT about_id,title,update_at FROM about_us ORDER BY update_at DESC"; // edit
}
...
$no = 1;
												...
												?>
												        <td><?php echo $no++; ?></td>
														<td><a href="<?php echo $cfg_baseurl; ?>us/"><?php echo $data_show['title']; ?></a></td>
														<td><?php echo $data_show['update_at']; ?></td>
														<td align="center">
															<a href="<?php echo $cfg_baseurl; ?>admin/about/edit/?id=<?php echo $data_show['about_id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
															<a href="<?php echo $cfg_baseurl; ?>admin/about/delete/?id=<?php echo $data_show['about_id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
