      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="kelola-testimonial-tab">
            <div class="form-group">
                <a href="<?php echo $cfg_baseurl; ?>admin/testimonial/add/" class="btn btn-primary btn-bordered waves-effect w-md waves-light"><i class="fa fa-plus"></i> Tambah Data </a>
            </div>
                                        <div class="table-responsive">
											<table class="table table-striped table-bordered table-hover m-0">
												...
												<?php
// start paging config
$query_list = "SELECT * FROM testimonial ORDER BY testimonial_id DESC"; // edit
...
$no = 1;
												while ($data_show = mysqli_fetch_assoc($new_query)) {
													$query_empty_pin = mysqli_query($db, "SELECT * FROM testimonial WHERE pinned = 'yes' ORDER BY testimonial_id DESC"); // edit
												?>
												        <td><?php echo $no++; ?></td>
												        <td><?php echo $data_show['customer_name']; ?></td>
														<td><a href="<?php echo $cfg_baseurl; ?>assets/images/testimonial/<?php echo $data_show['image']; ?>"><?php echo $data_show['image']; ?></a></td>
														<td><?php echo $data_show['update_at']; ?></td>
														<td align="center">
															<a href="<?php echo $cfg_baseurl; ?>admin/testimonial/edit/?id=<?php echo $data_show['testimonial_id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
															<a href="<?php echo $cfg_baseurl; ?>admin/testimonial/delete/?id=<?php echo $data_show['testimonial_id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
