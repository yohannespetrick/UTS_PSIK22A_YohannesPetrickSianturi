      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="kelola-profile-tab">
            <div class="form-group">
                <a href="<?php echo $cfg_baseurl; ?>admin/profile/add/" class="btn btn-primary btn-bordered waves-effect w-md waves-light"><i class="fa fa-plus"></i> Tambah Data </a>
            </div>
            <div class="form-group">
                <form method="GET">
                    <div class="input-group m-b-20">
                        <input type="text" name="search" class="form-control" placeholder="Cari nama orang..">
...
if (isset($_GET['search'])) {
	$search = $_GET['search'];
	$query_list = "SELECT profile_id,username,profile_name,update_at FROM profile WHERE profile_name LIKE '%$search%' ORDER BY update_at DESC"; // edit
} else {
	$query_list = "SELECT profile_id,username,profile_name,update_at FROM profile ORDER BY update_at DESC"; // edit
}
...
$no = 1;
												...
												?>
														...
														<td><?php echo $data_show['profile_name']; ?></td>
														<td><?php echo $data_show['update_at']; ?></td>
														<td align="center">
															<a href="<?php echo $cfg_baseurl; ?>admin/profile/edit/?id=<?php echo $data_show['profile_id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
															<a href="<?php echo $cfg_baseurl; ?>admin/profile/delete/?id=<?php echo $data_show['profile_id']; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
